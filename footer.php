    ...
    <div class="container d-md-flex justify-content-between">
        ...
        <div class="atendimento col-12 col-md-3 py-3">
            <div class="d-flex justify-content-center align-items-center text-center flex-column">
                ...
                <p>Envie <strong class="px-1">WhatsApp</strong> ou ligue <strong class="px-1">43 9 9102 5500</strong></p>
            </div>
        </div>
        <div class="faleconosco col-12 col-md-3 py-3">
            <div class="d-flex justify-content-center align-items-center text-center flex-column">
                ...
                <p class="m-0">Telefone: 43 9 9102 5502</p>
                <p class="m-0">E-mail: contato@sofasoft.com.br</p>
            </div>
        </div>
    </div>
</div>
