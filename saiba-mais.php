...
<div id="medindo" class="container-fluid px-0 m-0 py-16">
    <div class="container d-flex justify-content-center text-start flex-column">
        <h1 class="title px-3 col-10 my-0 py-0"><strong>O dobro de espuma</strong><br> dos sofás<br> tradicionais</h1>

        <div class="col-6 px-3">
            <div class="box col-12 py-2" data-aos="flip-down">
                <p class="fst-italic">"As espumas definem o conforto e a durabilidade de um sofá"</p>
            </div>
...
<div id="costurando" class="container-fluid px-0 m-0 pt-32">
