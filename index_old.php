...
<div class="container my-4">
    <div class="blue-border p-4 text-center">
        <h2 class="font-weight-bold">Comece a sua jornada e descubra o sofá perfeito para você!</h2>
        <div class="d-flex flex-column steps pt-3">
            <a><h1>Escolha o estilo</h1></a>
            <a><h1>Personalize</h1></a>
            <a><h1>Experimente</h1></a>
        </div>
        <button class="btn-colored-border comecar">Começar agora</button>
    </div>
    <p class="py-32 text-center"><strong class="px-1">Pesquisa durante anos,</strong>fizemos testes e criamos os sofás mais confortáveis, mais resistentes, com tudo o que você precisa e o melhor de tudo, <strong class="px-1">custando até a metade do preço.</strong></p>
</div>
...
<div class="container-fluid bg-gray py-32">
    <h1 class="text-center title pb-32"><strong>Qualidade</strong> garantida</h1>
    <img class="w-100" src="https://www.tilelook.com/system/tile_picture/resource/2336209/d3d_default_Pure_MA_Grey_60x60_FGYT660GR1.jpg"/>
...
<div class="container-fluid py-32">
    <h1 class="text-center title pb-16">Conforto <strong>incomparável,</strong> do jeito que você gosta.</h1>
    <img class="w-100" src="https://www.tilelook.com/system/tile_picture/resource/2336209/d3d_default_Pure_MA_Grey_60x60_FGYT660GR1.jpg"/>
</div>
